const cookiesPolicyMock = {
  id: '0.',
  title: 'Política de Cookies da Prime',
  language: 'pt-BR',
  version: '1.0',
  update_date: '24/04/2024',
  ...
  sections: [
    {
      id: '1.',
      section_title: 'O que são cookies?',
      paragraphs: [
    ...
    {
      id: '2.',
      section_title: 'Para que servem os cookies?',
      paragraphs: [
    ...
    {
      id: '3.',
      section_title: 'Que tipo de cookies utilizamos?',
      paragraphs: ['Os nossos cookies têm diferentes funções:'],
      list_items: [
        {
        ...
        {
          subtitle: 'Cookies de sessão:',
          paragraph:
            "São temporários, permanecem nos cookies do seu navegador de internet (browser) até sair do site. A informação obtida permite identificar problemas e fornecer uma melhor experiência de navegação. Depois de autorizar o uso de cookies, o usuário pode sempre desativar parte ou a totalidade dos nossos cookies. Todos os browsers permitem ao utilizador aceitar, recusar ou apagar cookies, nomeadamente através da seleção das definições apropriadas no respetivo navegador. Pode configurar os cookies no menu ''opções'' ou ''preferências'' do seu browser.",
          note: 'Note-se que, ao desativar cookies, pode impedir que alguns serviços da web funcionem corretamente, afetando, parcial ou totalmente, a navegação no website.',
        },
      ],
    },
  ],
...
export default cookiesPolicyMock;
